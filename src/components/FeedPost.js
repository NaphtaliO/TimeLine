  ...
  return (
    <>
        ...
        >
          ...
          <View style={{ flexDirection: "row" }}>
            ...
            <View style={{ alignSelf: "center" }}>
              ...
              <Text style={styles.timestamp}>{`${formatDistanceToNowStrict(
      ...
      >
        <TouchableWithoutFeedback
          onPress={() => {
            navigation.push("CommentsScreen", { post_id: item._id });
          }}
        >
          <Text style={{ paddingRight: 5 }}>
            {item.comments.length === 0 || item.comments.length > 1
        ...
        <TouchableWithoutFeedback
          onPress={() => {
            navigation.push("LikesScreen", { post_id: item._id });
          }}
        >
          <Text style={{ paddingRight: 5 }}>
            {item.likes.length === 0 || item.likes.length > 1
